...
namespace OrganizationManager
{
    public partial class regionPage : System.Web.UI.Page
    {
        ...
        protected void addProductButon_Click(object sender, EventArgs e)
        {
            ...
            string check = "select * from OrganizationInfo where RegionOfficeId = '" + location + "'";
        ...
        protected void Button19_Click(object sender, EventArgs e)
        {
            ...
            string national = "";
            string check1 = "select * from OrganizationInfo where RegionOfficeId = '" + location + "'";
            SqlCommand com1 = new SqlCommand(check1, conn2);
            SqlDataReader oReader1 = com1.ExecuteReader();
            while (oReader1.Read())
            {
            ...
            SqlCommand com13 = new SqlCommand(checkPhysician, conn);
            com13.Parameters.AddWithValue("@storeid", TextBox2.Text);
            com13.Parameters.AddWithValue("@zone", TextBox1.Text);
            com13.Parameters.AddWithValue("@region", location);
