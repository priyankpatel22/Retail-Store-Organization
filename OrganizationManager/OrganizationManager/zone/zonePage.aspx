<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="zonePage.aspx.cs" Inherits="OrganizationManager.zonePage" %>
...
<body style="color: #000066">
 <form id="form2" runat="server">
    ...
    <div class="auto-style1">
        ...
        <strong>Welcome to Zone Utility</strong></div>
    <p>
        &nbsp;</p>
    <p class="auto-style8">
     ...
     <br />
     <asp:Button ID="Button1" runat="server" OnClick="addProductPop_Click1" Text="Add New Item" Width="145px" BackColor="White" BorderColor="White" BorderStyle="None" ForeColor="#391878" style="font-weight: 700" CssClass="auto-style34" />
      
     <span class="auto-style34">&nbsp;&nbsp;
     </span>
     <asp:Button ID="Button4" runat="server" OnClick="Button4_Click" Text="Remove Product" Width="150px" BackColor="White" BorderColor="White" BorderStyle="None" ForeColor="#391878" style="font-weight: 700" CssClass="auto-style34" />
      
     <span class="auto-style34">&nbsp;&nbsp;
     </span>
     <asp:Button ID="Button8" runat="server" OnClick="Button8_Click" Text="Search Item" Width="119px" BackColor="White" BorderColor="White" BorderStyle="None" ForeColor="#391878" style="font-weight: 700" CssClass="auto-style34" />
      
     <span class="auto-style34">&nbsp;&nbsp;&nbsp; </span> <asp:Button ID="Button10" runat="server" OnClick="Button10_Click" Text="Employee Details" Width="150px" BackColor="White" BorderColor="White" BorderStyle="None" ForeColor="#391878" style="font-weight: 700" CssClass="auto-style34" />
      
     <span class="auto-style34">&nbsp;&nbsp;&nbsp; </span> <asp:Button ID="Button12" runat="server" OnClick="Button12_Click" Text="Change Price" Width="141px" BackColor="White" BorderColor="White" BorderStyle="None" ForeColor="#391878" style="font-weight: 700" CssClass="auto-style34" />
      
     &nbsp;<asp:Button ID="Button13" runat="server" OnClick="Button13_Click" Text="Check Sales" Width="130px" BackColor="White" BorderColor="White" BorderStyle="None" ForeColor="#391878" style="font-weight: 700" CssClass="auto-style34" />
     ...
     <asp:Button ID="Button17" runat="server" BackColor="White" BorderColor="White" BorderStyle="None" ForeColor="#391878" OnClick="Button17_Click" style="font-weight: 700" Text="Payroll" CssClass="auto-style34" />
      
     <span class="auto-style34">&nbsp;&nbsp;&nbsp;
     </span>
     <asp:Button ID="Button18" runat="server" BackColor="White" BorderColor="White" BorderStyle="None" ForeColor="#391878" style="font-weight: 700" Text="Transfer Item" OnClick="Button18_Click" CssClass="auto-style34" />
      
     &nbsp;&nbsp;&nbsp;
      
     <asp:Button ID="addStore" runat="server" BackColor="White" BorderColor="White" BorderStyle="None" ForeColor="#391878" OnClick="addStore_Click" style="font-weight: 700" Text="Add Store" CssClass="auto-style34" />
     ...
     <br />
     <asp:Panel ID="Panel12" runat="server" style="margin:auto" Width="477px" Visible ="false">
         <div class="auto-style11">
             <strong>Add Store<br />
             <br />
             <table class="auto-style2">
                 <tr>
                     <td class="auto-style33">Store Id:</td>
                     <td style="text-align: left">
                 ...
                 <tr>
                     ...
                     <td style="text-align: left">
                         <asp:Button ID="Button19" runat="server" OnClick="Button19_Click" Text="Add" />
                     </td>
                 </tr>
             </table>
             <br />
