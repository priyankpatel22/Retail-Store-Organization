...
{
    public partial class nationalPage : System.Web.UI.Page
    {
        ...
        protected void addProductButon_Click(object sender, EventArgs e)
        {
            ...
            string check = "select * from OrganizationInfo where NationalOfficeId = '" + location + "'";
        ...
        protected void Button19_Click(object sender, EventArgs e)
        {
            ...
            SqlCommand com13 = new SqlCommand(checkPhysician, conn);
            com13.Parameters.AddWithValue("@storeid", TextBox3.Text);
            com13.Parameters.AddWithValue("@zone", TextBox2.Text);
            com13.Parameters.AddWithValue("@region", TextBox1.Text);
            com13.Parameters.AddWithValue("@nation", location);
            com13.ExecuteNonQuery();
            conn.Close();
        }
    }
