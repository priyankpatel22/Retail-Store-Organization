<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="regionPage.aspx.cs" Inherits="OrganizationManager.regionPage" %>
...
<body style="color: #000066">
 <form id="form2" runat="server">
    ...
    <div class="auto-style1">
        ...
        <strong>Welcome to Region Utility</strong></div>
    <p>
        &nbsp;</p>
    <p class="auto-style8">
     ...
     <asp:Button ID="Button1" runat="server" OnClick="addProductPop_Click1" Text="Add New Item" Width="145px" BackColor="White" BorderColor="White" BorderStyle="None" ForeColor="#391878" style="font-weight: 700" CssClass="auto-style32" />
      
     <span class="auto-style32">&nbsp;&nbsp;
     </span>
     <asp:Button ID="Button4" runat="server" OnClick="Button4_Click" Text="Remove Product" Width="150px" BackColor="White" BorderColor="White" BorderStyle="None" ForeColor="#391878" style="font-weight: 700" CssClass="auto-style32" />
      
     <span class="auto-style32">&nbsp;&nbsp;
     </span>
     <asp:Button ID="Button8" runat="server" OnClick="Button8_Click" Text="Search Item" Width="119px" BackColor="White" BorderColor="White" BorderStyle="None" ForeColor="#391878" style="font-weight: 700" CssClass="auto-style32" />
      
     <span class="auto-style32">&nbsp;&nbsp;&nbsp; </span> <asp:Button ID="Button10" runat="server" OnClick="Button10_Click" Text="Employee Details" Width="150px" BackColor="White" BorderColor="White" BorderStyle="None" ForeColor="#391878" style="font-weight: 700" CssClass="auto-style32" />
      
     <span class="auto-style32">&nbsp;&nbsp;&nbsp; </span> <asp:Button ID="Button12" runat="server" OnClick="Button12_Click" Text="Change Price" Width="141px" BackColor="White" BorderColor="White" BorderStyle="None" ForeColor="#391878" style="font-weight: 700" CssClass="auto-style32" />
      
     &nbsp;<asp:Button ID="Button13" runat="server" OnClick="Button13_Click" Text="Check Sales" Width="130px" BackColor="White" BorderColor="White" BorderStyle="None" ForeColor="#391878" style="font-weight: 700" CssClass="auto-style32" />
     ...
     <asp:Button ID="Button17" runat="server" BackColor="White" BorderColor="White" BorderStyle="None" ForeColor="#391878" OnClick="Button17_Click" style="font-weight: 700" Text="Payroll" CssClass="auto-style32" />
      
     <span class="auto-style32">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
     </span>
     <asp:Button ID="Button18" runat="server" BackColor="White" BorderColor="White" BorderStyle="None" ForeColor="#391878" style="font-weight: 700" Text="Transfer Item" OnClick="Button18_Click" CssClass="auto-style32" />
      
     <span class="auto-style32">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
      
     </span>
      
     <asp:Button ID="addStore" runat="server" BackColor="White" BorderColor="White" BorderStyle="None" ForeColor="#391878" OnClick="addStore_Click" style="font-weight: 700" Text="Add Store" CssClass="auto-style32" />
     ...
     <br />
     <asp:Panel ID="Panel12" runat="server" style="margin:auto" Width="475px" Visible ="false">
         <div class="auto-style11">
             <strong>Add New Office<br />
             <br />
             <table class="auto-style2">
                 <tr>
                     <td class="auto-style31">Add Zone:</td>
                     <td class="auto-style12">
                         <asp:TextBox ID="TextBox1" runat="server"></asp:TextBox>
                     </td>
                 </tr>
                 <tr>
                     <td class="auto-style31">Add Store: </td>
                     <td class="auto-style12">
